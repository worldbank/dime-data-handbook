...
Good code is code that both generates the correct result \textit{and} 
is easily read by other professionals in our field.
...
\section{Writing code that is both correct and good}
...
(from tomorrow, that stranger is most likely the future you!).
...
Whether you are new to the programming language you are suing,
(Stata, R, Python etc.)
or have used it for decades,
...
as the only way to get better at the programming language you use
...
Our code examples are commented generously (as you should),
...
We use GitHub to version control all content of this book,
including the code examples.
To see the code examples on GitHub, go to: \url{https://github.com/worldbank/d4di/tree/master/code}.
...
\url{https://github.com/worldbank/d4di/archive/master.zip}. 
...
While we try to refer to built-in commands as much as possible in this book,
we point to user-written functions when they provide important tools.
...
In our code examples use \texttt{randtreat} or \texttt{ieboilstart}.
