...
Providing some standardization to Stata code style
is also a goal of our team.
Stata is one of several programming languages used at DIME,
but since it exists fewer good resources based on Stata,
we decided to use Stata for our examples in this book.
