...
is easily read by other professionals.
...
(and, tomorrow, we are strangers even to our past selves).
...
Whether you are new to the programming language you are using,
...
To see the code examples on GitHub, go to: \url{https://github.com/worldbank/dime-data-handbook/tree/master/code}.
