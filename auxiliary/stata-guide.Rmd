...
```{stata, eval = F, code = readLines("code/stata-comments-1.do"), attr.source='.numberLines'}
```

#### Commenting a single line {-}
```{stata, eval = F, code = readLines("code/stata-comments-2.do"), attr.source='.numberLines'}
```

#### Inline comments {-}
```{stata, eval = F, code = readLines("code/stata-comments-3.do"), attr.source='.numberLines'}
```
...
#### GOOD:
```{stata, eval = F, code = readLines("code/stata-loops-1.do"), attr.source='.numberLines'}
```
...
#### ACCEPTABLE:
```{stata, eval = F, code = readLines("code/stata-whitespace-columns-1.do"), attr.source='.numberLines'}
```

#### GOOD:
```{stata, eval = F, code = readLines("code/stata-whitespace-columns-2.do"), attr.source='.numberLines'}
```
...
#### GOOD:
```{stata, eval = F, code = readLines("code/stata-whitespace-indentation-1.do"), attr.source='.numberLines'}
```

#### BAD:
```{stata, eval = F, code = readLines("code/stata-whitespace-indentation-2.do"), attr.source='.numberLines'}
```
...
#### GOOD:
```{stata, eval = F, code = readLines("code/stata-conditional-expressions-1a.do"), attr.source='.numberLines'}
```

#### BAD:
```{stata, eval = F, code = readLines("code/stata-conditional-expressions-1b.do"), attr.source='.numberLines'}
```
...
#### GOOD:
```{stata, eval = F, code = readLines("code/stata-conditional-expressions-2a.do"), attr.source='.numberLines'}
```

#### BAD:
```{stata, eval = F, code = readLines("code/stata-conditional-expressions-2b.do"), attr.source='.numberLines'}
```
...
::: {.ex}
#### GOOD:
```{stata, eval = F, code = readLines("code/stata-filepaths-1.do"), attr.source='.numberLines'}
```

#### BAD: Relative paths
```{stata, eval = F, code = readLines("code/stata-filepaths-2.do"), attr.source='.numberLines'}
```

#### BAD: Static paths
```{stata, eval = F, code = readLines("code/stata-filepaths-3.do"), attr.source='.numberLines'}
```
...
#### GOOD:
```{stata, eval = F, code = readLines("code/stata-linebreak-1.do"), attr.source='.numberLines'}
```

#### BAD:
```{stata, eval = F, code = readLines("code/stata-linebreak-2.do"), attr.source='.numberLines'}
```

#### UGLY:
```{stata, eval = F, code = readLines("code/stata-linebreak-3.do"), attr.source='.numberLines'}
```
...
#### GOOD:
```{stata, eval = F, code = readLines("code/stata-boilerplate-1.do"), attr.source='.numberLines'}
```
#### ACCEPTABLE:
```{stata, eval = F, code = readLines("code/stata-boilerplate-2.do"), attr.source='.numberLines'}
```
...
::: {.ex}
<br>
```{stata, eval = F, code = readLines("code/stata-misc.do"), attr.source='.numberLines'}
```
