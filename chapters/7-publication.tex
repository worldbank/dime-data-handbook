...
Academic journals often require a ``replication package''
...
Hence, this process is the conclusion of the system
...
and then have the folders \texttt{img} for figures,
\texttt{tab} for tables, and \texttt{etc} for anything else.
...
in addition to the data that produces your results,
you provide the code =used to create the results.
...
is often referred to as a ``replication package''.
...
The code and data should exactly reproduce
the raw outputs you have used for the paper,
and the replication file should only include material for public release.
