...
Academic journals and policy notes are commonly supported by
reproducibility packages which contain the data, code, and supporting materials
needed to recreate the results.
Preparation of a reproducibility package is a prerequisite
...
First, you should catalog the corrected and de-identified raw data
...
with only the published raw data in hand.
...
One solution is to add noise to data, as the U.S. Census Bureau has proposed.\cite{abowd2018us}
...
you will decide how the data may be used and what license you will assign to it.\sidenote{
  \url{https://dimewiki.worldbank.org/Publishing_Data}}\index{data licensing}
...
This chapter described a the process that brings all your efforts together --
the production of materials to share with the world
that combine design, data, processing, and analysis
to answer a scientific or policy question in a way that has 
never been done before.
Making sure that everything you discovered and created
is as broadly available and as easy to use as possible
is the last step in producing scientific work from original data.
...
From here on, what to do with that is your decision.
