...
First, you should choose the platform where you will publish your data.
A variety of options exist; 
most important is to choose one that allows you to obtain a digital object identifier (DOI)
...
and do not include indicators constructed by the research team. 
Even if you do not have rights to publish the original data, 
you typically can publish derivative datasets prepared by the research team.
These datasets typically contains only the constructed indicators and associated documentation.\sidenote{
  \url{https://guide-for-data-archivists.readthedocs.io}}
This is typically the dataset included in the replication package.
...
and enable others to apply similar methods in future projects.
Others should be able to reproduce individual portions of your analysis
...
through the use of clean structure and extensive commenting.
...
quarterly peer code review rounds, which allow research assistants to improve their code and documentation as it is written,
...
Readers should also be able to quickly map all the outputs of the code
