...
% Chapter overview
The tasks described in this chapter are called by many different names.
Some would say data cleaning, others data munging, or maybe data wrangling.
It means transforming raw data into a more convenient format for your intended use.
