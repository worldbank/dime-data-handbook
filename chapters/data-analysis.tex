...
It is at this stage that the raw data is transformed into analysis-ready data, 
...
To do this, you will need to consider the unit of response for each dataset, 
and the identifying variable, to understand how they can be merged.

If the datasets you need to join have the same unit of response, 
merging may be straightforward.
The simplest case is merging datasets at the same unit of response 
which use a consistent numeric ID.
...
datasets at the same unit of response may not use a consistent numeric identifier.
...
In other cases, you will need to join data sources that have different units of response.
...
Primary panel data presents additional timing complexities.
