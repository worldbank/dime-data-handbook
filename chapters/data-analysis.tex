...
Additionally, no one who is not listed in the IRB should be able to access its content, not even the company providing file-sharing services. Check if your organization has guidelines on how to store data securely, as they may offer an institutional solution. If that is not the case, you will need to encrypt the file and make sure that only IRB-listed team members have the encryption key.\sidenote{\url{https://dimewiki.worldbank.org/wiki/Encryption}}.
