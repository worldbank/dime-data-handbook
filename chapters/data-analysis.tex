...
\texttt{iefielkit}'s \texttt{iecodebook}
function lists all variables in a data set and exports an Excel sheet
...
assess them against the pre-analysis plan and ask: 
