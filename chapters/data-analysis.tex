...
First, \textbr{renaming}: for data with an accompanying survey instrument, 
...
Third, \textbf{recoding}: codes for ``Don't know'', ``Refused to answer'', and
other non-responses should be recoded into extended missing values.\sidenote{
...
data collection reports, field plans, data collection manuals, survey instruments,
