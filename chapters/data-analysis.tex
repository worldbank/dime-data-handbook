...
This is done by creating derived variables (binaries, indices, and interactions, to name a few), 
...
% Outputs -----------------------------------------------------------------
When dealing with primary panel data, is it common to construct indicators soon after receiving data from a new survey round.
Dealing with primary panel data also has its own complexities.
