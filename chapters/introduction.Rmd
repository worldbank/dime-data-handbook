...
```{r, fig.cap = "FIGURE I.1 Overview of the tasks involved in development research data work", echo = FALSE}
...
Safe Spaces study rather than on the results. A working paper by Kondylis et al.
(2020) provides more information about the findings from this study and how it
was conducted.
...
research design accurately (@vilhuber\_lars\_2020\_3911311) and to minimize
