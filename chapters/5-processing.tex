...
to understand the \textbf{unit of observation}\sidenote{
	...
	In a data table, it is ideally what each row represents.
...
should either publish or archive and catalogue the cleaned dataset.
This will help organize your files and create a backup,
and some donors require that the data be filed as an intermediate output.
But the reason why you acquired and cleaned this data was to answer a research question.
Data cleaning is typically the most time-consuming process in the data work,
but it ensures that the data is ready to be analyzed.
