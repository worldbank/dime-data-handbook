...
This process, called data cleaning and processing,
creates your first research outputs using original data:
an analysis-ready dataset.
This dataset is a clear representation of reality (it is ``tidy''),
...
Once you have completed these steps and
and compiled the documentation to accompany your work,
you have created the first research output of your project: an original dataset.
Combined with the data map, this product 
will be the fundamental starting point for all analysis work.
Archiving, cataloging, and publishing this dataset 
will organize your files and create a backup of the data.
...
to finally run the analyses originally specified in your research plan
