...
is the \textbf{unique identifier} for each observation.\sidenote{
	More details on the properties are needed for variables
...
to data in other data sources according to the \textbf{data linkage table},\sidenote{
	More details on data linkage tables and an example
	can be found on the DIME Wiki:
...
must be listed in the \textbf{master dataset}.\sidenote{
	More details on master datasets and an example
	can be found on the DIME Wiki:
...
package\index{iefieldkit}.
One advantage of using \texttt{ieduplicates}\sidenote{
	Read more about how \texttt{ieduplicates} can help you
	efficiently deal with duplicates,
	and how to install and use this command on the DIME Wiki:
...
the research team should develop a \textbf{data quality assurance plan}.\sidenote{
  More details on data quality assurance plans and
	links to other resources can be found on the DIME Wiki:
...
or other mistakes.\sidenote{
  More details on how to deal with duplicates and tracking survey completion
	can be found on the DIME Wiki:
...
data is not falsified, incomplete, or otherwise suspect.\sidenote{
  More details on back checks and
	links to related tools can be found on the DIME Wiki:
...
assess whether enumerators are conducting interviews as expected.\sidenote{
  \url{https://dimewiki.worldbank.org/Random\_Audio\_Audits}}
...
where you can easily select which variables to keep or drop.\sidenote{
  More details on iecodebook,
	how it can help in de-identification and other cleaning tasks,
	and how to install and use this command can be found on the DIME Wiki:
