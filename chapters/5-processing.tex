...
It may be the case that the variables expected to be unique identifiers 
are either incomplete or contain duplicates.
...
This is due to the fact that effective data collection and quality monitoring
...
Examples include geocoordinates or village names
(after constructing measures of distance or area,
drop the specific location)
and names for social network analysis 
(which can be encoded to secret and unique IDs).
