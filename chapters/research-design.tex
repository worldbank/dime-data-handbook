...
provides more detailed mathematical approaches fo the tools.\sidenote{
...
are canonical treatments of the statistical principles behind all econometric approaches.\sidenote{
...
The coarsened exact matching (`cem`) package applies the nonparametric approach.\sidenote{
...
os passengers or cargo shipments in the case of transport corridors, for example.\cite{gobillon2016regional}
...
The `synth` package provides functionality for use in Stata,
although since there are a large number of possible parameters
and implementations of the design it can be complex to operate.s\sidenote{
