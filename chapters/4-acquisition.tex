...
The first step is to develop a detailed \textbf{enumerator manual}.\sidenote{See the DIME Wiki
	for a more detailed discussion of how to design an enumerator manual and a template for enumerator manuals: 
...
and standardized means for recording responses such as "Don't know".\sidenote{See the DIME Wiki
	for examples of common survey protocols: \url{https://dimewiki.worldbank.org/Survey\_Protocols}}
	\index{survey protocols}

The enumerator manual serves as the basis for \textbf{enumerator training}.
	\index{enumerator training}
We recommend that training be divided into two sessions:
first a training-of-trainers, and then enumerator training. 
...
and should be jointly led by the research team and the survey managers.\sidenote{For an
	in-depth discussion of enumerator training, see the DIME Wiki: 
...
for the survey, and to include objective assessments throughout the training.\sidenote{For a more
...
for the duration of the survey.\sidenote{To learn more about what types of checks should be included in the HFCs,
	see the DIME Wiki: https://dimewiki.worldbank.org/High\_Frequency\_Checks}}
