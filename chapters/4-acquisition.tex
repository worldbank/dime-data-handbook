...
You should make a simple \texttt{README} document noting the date of receipt,\index{\texttt{README}}
...
DIME Analytics developed the \texttt{ietestform} command,\sidenote{
  \url{https://dimewiki.worldbank.org/ietestform}}\index{\texttt{ietestform}}
part of the Stata package \texttt{iefieldkit},\index{\texttt{iefieldkit}}
...
exactly as recieved and finalized,
...
It outlined guidelines for ensuring you have effective ownership
or licensing of data that you obtain or collect,
and how to make those materials available in the future.
It also provided an extensive guide for one of the most popular --
and challenging --
...
to transferring and storing data securely at all times.
