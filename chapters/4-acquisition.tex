...
All established survey software includes debugging and test options
...
\index{encryption}\textbf{Data encryption} 
is a group of methods that ensure that files are unreadable 
even if laptops are stolen, servers are hacked, 
or unauthorized access to the data is obtained in another way.\sidenote{
...
instead, use a secure password manager.\sidenote{
	...
	among many others. See the DIME Analytics guide to password managers: \url{
