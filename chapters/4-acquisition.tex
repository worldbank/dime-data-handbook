...
These datasets are the objects you will think about cataloging, releasing, and licensing
...
There are many survey software options available to researchers, and the market is rapidly evolving.
...
Therefore, we focus on specific workflow considerations for digitally-generated data, and on primary concepts rather than software-specific tools.
...
The starting point for questionnaire programming is a complete paper version of the questionnaire,
...
DIME's guidelines for encryption in SurveyCTO/ODK -
...
as long as you only share the key using a secure service like a password manager.
Anyone who has access to both the encrypted folder and the encryption key
can read and collaborate on the encrypted file,
but it is impossible to know anything about your data if you only have access to one of them.
