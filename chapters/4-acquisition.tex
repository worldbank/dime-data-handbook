...
Data ownership\index{data ownership}
...
and \textbf{research design}\sidenote{
  ...
  \url{https://dimewiki.worldbank.org/wiki/Experimental_Methods}
	and \url{https://dimewiki.worldbank.org/wiki/Quasi-Experimental_Methods}}\index{research design}
  for your project.
...
At this point, it is useful to do a \textbf{survey pilot}\sidenote{
  More details on how to structure survey pilots,
	the different components of comprehensive survey pilot and
	link to many other resources can be found on the DIME Wiki:
 \url{https://dimewiki.worldbank.org/Survey\_Pilot}}\index{survey pilot}
of the questionnaire.
A checklist for how to prepare for a survey pilot can be found on the DIME Wiki: https://dimewiki.worldbank.org/Checklist:_Preparing_for_a_Survey_Pilot.
...
within a module stay together when sorted alphabetically.\sidenote{
  ...
  \url{https://dimewiki.worldbank.org/Naming_Conventions}}\index{variable naming}
