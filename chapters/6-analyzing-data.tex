...
is preferable as the amount of code to review is more manageable and
...
raw data. The only datasets that cannot be re-created are the raw data
themselves.
...
Note that this implies re-expressing categorical variables like \texttt{sex} to binary variables like \texttt{female}.)
