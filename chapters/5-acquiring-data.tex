...
% intro: discuss practices, not software
...
% use pre-coded response options
...
% communicating isues in real time
...
% don't trust encryption that you did not set up
...
% asymmetric encryption at must be implemented in survey collection servers
