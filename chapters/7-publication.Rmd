...
```{block2, type = 'ex'}
BOX 7.4 RELEASING A REPRODUCIBILITY PACKAGE: A CASE STUDY FROM THE DEMAND FOR
SAFE SPACES PROJECT
...
![*Demand for Safe Spaces* GitHub landing page](examples/home.png)

![*Demand for Safe Spaces* reproducibility package](examples/github.png)
