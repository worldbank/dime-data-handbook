...
This process is in part meant to combat the ``file-drawer problem''\cite{simonsohn2014p}\index{file-drawer problem}
...
through commit messages, issues, \texttt{README} files, and pull requests,\sidenote{
	\url{https://dimewiki.worldbank.org/Getting_started_with_GitHub}}\index{task management}\index{GitHub}\index{\texttt{README}}
...
placed in an archival repository where it can be cited.\cite{vilhuber2020report}\index{data publication}
