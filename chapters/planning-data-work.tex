...
you must set up secure systems for data transfer and storage from the outset of a project.\sidenote{
...
Second, you must encrypt datasets that include confidential information\sidenote{
