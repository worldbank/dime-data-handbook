...
and how big and sensitive it will be.
...
Teams often develop workflows as they go,
...
However, since each project will always have its own specific needs,
...
The code in \texttt{stata-master-dofile.do} how folder structure is reflected in a master do-file.
...
GitHub allows tasks to be clearly tied to file versions;
...
Dropbox Paper allows for tasks to be easily linked to other documents saved in Dropbox;
