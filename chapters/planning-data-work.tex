...
\sidenote{\url{https://www.backblaze.com/blog/the-3-2-1-backup-strategy/}}
...
The first thing your team will need to create is a shared folder.\marginnote{Common tools for folder sharing are Dropbox, Box, OneDrive.}
...
\sidenote{https://dimewiki.worldbank.org/wiki/Master_Do-files} 
...
you can go straight to \textttt{PART 2: Create new variables}, 
...
We recommend using \texttt{Git}\marginnote{\textbf{Git}} for all plain text files. 
...
\marginnote{Add link and definition} tools.
...
such as German Rodriguez' Markstat\sidenote{\url{https://data.princeton.edu/stata/markdown}},
Stata15 dynamic documents\sidenote{\url{https://www.stata.com/new-in-stata/markdown/}},
and Ben Jann's webdoc\sidenote{\url{http://repec.sowi.unibe.ch/stata/webdoc/index.html}} and 
texdoc\sidenote{\url{http://repec.sowi.unibe.ch/stata/texdoc/index.html}}. 
...
so, for example, \texttt{merge.do} creates \textttt{merged.dta}.
...
\textttt{descriptive\_statistics.do} create \textttt{descriptive\_statistics.tex}. 
