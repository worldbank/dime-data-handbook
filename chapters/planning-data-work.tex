...
Big data sets require additional infrastructure and may overburden
the traditional tools used for small data sets,
...
but we are going to broadly assume that you are using desktop-sized data sets
...
Nearly all code files and raw outputs (not data sets) are best managed this way.
