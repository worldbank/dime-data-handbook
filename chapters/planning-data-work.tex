...
Mixed among the code itself, are two types of comments that should be included.
...
These are often highly specialized and may exploit functionality
...
If you wait for a long time to have your code review, and it gets too complex,
...
is also the easiest way to be prepared in advance for a smooth project handover.
...
Once you are happy with a partiular result or output,
