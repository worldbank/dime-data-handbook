...
To build this plan, you will need to prepare collaborative tools and workflows.
Changing software or protocols half-way through a project can be costly and time-consuming,
so it's important to think ahead about decisions that may seem of little consequence.
For example, things as simple as sharing services, folder structures, and file names
...
We will write file paths such as \path{/Dropbox/project-titleDataWorkEncryptedData/}
...
If you are working with others, you will most likely be using
some kind of active file sharing software.
The exact providers and combinations you use will depend on your tasks,
...
and is implemented by tools like Git and GitHub.
Version control allows everyone to access different versions at the same time,
...
Setting up the \texttt{DataWork} folder folder in a git-managed directory
