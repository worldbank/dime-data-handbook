...
and here we provide some basic guidelines and responsibilities for both
...
In the first group are tools such as R's RMarkdown\sidenote{\url{https://rmarkdown.rstudio.com/}}
...
One of the most common issues you will face using Overleaf's ``rich text'' 
editor will be special characters
