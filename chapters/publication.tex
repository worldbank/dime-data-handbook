...
\begin{minipage}{1.5\textwidth}
	...
	label=sample.bib, %name of code section
	...
	]{./code/sample.bib} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=citation.tex, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/citation.tex} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=pandoc.sh, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/pandoc.sh} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
