...
https://dimewiki.worldbank.org/Data\_Map.]. The data map is intended to ensure
...
https://dimewiki.worldbank.org/Data\_Linkage\_Table.] lists all of the original
...
https://dimewiki.worldbank.org/Master\_Data\_Set.] is created and maintained,
...
https://dimewiki.worldbank.org/Data\_Flow\_Charts.] are created, describing how
...
DIME Wiki at https://dimewiki.worldbank.org/ID\_Variable\_Properties.] (ID)
...
IAT—three with IAT scores (one for each instru- ment) and three with detailed
...
<https://git.io/Jtg3J> *Note:* IAT = implicit association test; ID = identifying
variable.
...
https://dimewiki.worldbank.org/Experimental\_Methods.], such as *randomized
...
https://dimewiki.worldbank.org/Randomized\_Control\_Trials.] (RCTs), the
...
https://dimewiki.worldbank.org/Quasi-Experimental\_Methods.], by contrast, are
...
https://dimewiki.worldbank.org/Regression\_Discontinuity.] (RD) designs exploit
...
the DIME Wiki at https://dimewiki.worldbank.org/Instrumental\_Variables.] (IV)
...
https://dimewiki.worldbank.org/Administrative\_and\_Monitoring\_Data.] are very
...
https://dimewiki.worldbank.org/Randomization\_in\_Stata.], two additional
...
principles translate to all other programming languages.
  ...
  - *Rule 1: Versioning* requires using the same version of the software each
    ...
    **master do-file**) is a single code script that can be used to execute all
    ...
    https://dimewiki.worldbank.org/Master\_Do-files.] is recommended. Testing
  ...
  - *Rule 2: Sorting* requires using a fixed order of the actual data on which
    ...
    change the result of the process. In Stata, using `isid [id_variable]`,
    `sort` is recommended to guarantee a unique sorting order. This command does
...
details, see the DIME Wiki at
https://dimewiki.worldbank.org/Clustered\_Sampling\_and\_Treatment\_Assignment.]
...
https://dimewiki.worldbank.org/Stratified\_Random\_Sample.] splits the full set
...
guaranteed to be nonzero: this is called *in-sample* or *finite-sample
correlation*.
...
the strengths and weaknesses are located and to under- stand the relative
...
https://dimewiki.worldbank.org/Minimum\_Detectable\_Effect.] (MDE) is the
...
https://dimewiki.worldbank.org/Randomization\_Inference.] is used to analyze
