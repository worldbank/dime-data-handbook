...
(Going forward, this section will use ``randomization'' to refer to the whole process
of sampling and randomization: the relevant study design will often include both.)
