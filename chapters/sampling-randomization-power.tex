...
\subsection{Creating a master dataset and linking it to field data}
...
for each of those units-of-observation\sidenote{
	\url{https://dimewiki.worldbank.org/Unit\_of\_Observation}}
and include that in your required datasets.
...
\subsection{Preparing master data for sampling and randomization}
...
to ensure you can get those exact results again.\sidenote{
...
In ordinary use, by the time you get to any given script, its will be as good as random.\sidenote{
