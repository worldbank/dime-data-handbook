...
Clustered sampling and randomization are straightforward in Stata.
To sample or randomize at the cluster level,
create or use a data set where each cluster unit is a row,
sample or randomize on that data set, and then merge back the results.
...
At the end of the day, power calculations will typically suggest
more efficient and focused study designs
with better power to answer your key questions.
...
that the random treatment assignment process, by chance,
