...
\marginnote{You can draw a standard seed randomly by visiting \url{http://bit.ly/stata-random}.
...
\begin{minipage}{1.5\textwidth}
	...
	label=replicability.do, %name of code section
	...
	]{./code/replicability.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}

Commands like \texttt{bys:} and \texttt{merge} will re-sort your data as part of their execution,
\marginnote{To reiterate: any process that includes a random component
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=randomization-cf.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/randomization-cf.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=simple-sample.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/simple-sample.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=sample-noise.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/sample-noise.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\marginnote{Programming takes a few lines of code that may be new to you,
...
\marginnote[2\baselineskip]{The \texttt{syntax, [*]} programming command allows the \texttt{ritest}
program to later be used for randomization inference.
Note that we don't include the reproducibility code here,
precisely because we want the results of this code
to be able to vary.}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=randomization-program-1.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/randomization-program-1.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\marginnote{The reason we cannot use \texttt{ieboilstart} here
is that it will remove these types of programs from memory.}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=randomization-program-2.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/randomization-program-2.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
To control randomization noise, we often use techniques\marginnote{
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=randtreat-strata.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/randtreat-strata.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=randtreat-clusters.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/randtreat-clusters.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=minimum-detectable-effect.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/minimum-detectable-effect.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\begin{minipage}{1.5\textwidth}
	...
	\VerbatimInput[frame=lines, % line above and below code section
	numbers=left, %Line number
	label=minimum-sample-size.do, %name of code section
	samepage=true, %Do not allow the code to be broken across pages
	baselinestretch=0.75 %Use line space more similat to line space in code editors
	]{./code/minimum-sample-size.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
