...
(Note that there are two distinct random processes referred to here:
...
Note that you will \textit{never} be able to reproduce a randomization in a different software,
...
but instead you should set one in code right before each random process.
