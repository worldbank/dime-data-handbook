...
For example, you may have different levels of \textbf{unit of observation}\sidenote{
...
A study that observes data in multiple time periods is called \textbf{longitudinal}\index{longitudinal data}
and can either be a \textbf{repeated cross-sections}
or a \textbf{panel data} study.\index{panel data} \index{repeated cross-sectional data}
...
You must keep track of the \textit{attrition rate} in longitudinal data,
...
very important for the validity of your research is \textbf{monitoring data}.\sidenote{
...
%-----------------------------------------------------------------------------------------------
%-----------------------------------------------------------------------------------------------
\section{Implementing sampling and randomized designs}
...
to be included in data collection as the cost of collecting data on everyone is prohibitive.\sidenote{
...
than the unit of sampling or unit of treatment assignment.\sidenote{
	\url{https://dimewiki.worldbank.org/Unit\_of\_Observation}}
