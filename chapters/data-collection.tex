...
there is no way for others to validate that it accurately reflects reality
...
Particularly when confidential data is being collected at your behest
...
You will typically want intellectual property rights to all derivative works developed used the data,
...
either the original licensed dataset or the derived materials.
...
and that the data collection will not be distributed to any third parties
...
Will you publicly releasing the data in full (removing personal identifiers))?
...
Would you prefer to decided permission on a case-by-case basis, dependent on specific proposed uses? 
...
World Bank's Microdata Catalog.\sidenote{\url{microdata.worldbank.org}}
