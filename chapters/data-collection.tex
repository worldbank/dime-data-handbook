...
are essential data components for completing CONSORT\sidenote{\textbf{CONSORT:} a standardized system for reporting enrollment, intervention allocation, follow-up, and data analysis through the phases of a randomized trial of two groups.} records.\cite{begg1996improving}
...
\sidenote{\textbf{Likert scale:} an ordered selection of choices
indicating the respondent's level of agreement or disagreement
with a proposed statement.}
...
\sidenote{\textbf{Encryption:} the process of making information unreadable
