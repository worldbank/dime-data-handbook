...
https://dimewiki.worldbank.org/wiki/IRB\_Approval}} for the specific project has the 
...
are hacked, or unauthorized access to the data is obtained in any other way.\sidenote{\url{
https://dimewiki.worldbank.org/wiki/Encryption}} Proper encryption is rarely just one thing as 
...
instead you must use a secure password manager\sidenote{\url{https://lastpass.com} or 
\url{https://bitwarden.com}}. In addition to providing a way to securely share passwords, password 
...
It is possible in some enterprise versions of data sharing softwares, to set up on-the-fly encryption. 
...
be lost in case of hardware failure.\sidenote{\url{
https://www.backblaze.com/blog/the-3-2-1-backup-strategy/}} However, you still
...
To simplify the workflow, the PII variables should be removed from your data at the earliest 
