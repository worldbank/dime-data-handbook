...
When you are using original data there is no way for anyone else in the research community to validate that it accurately reflects reality
and that the indicators you have based your analysis on are meaningful.
This chapter details the necessary components for a high-quality and secure data acquisition process,
which apply equally if you are receiving large amounts of unique data from partners
or fielding a small, specialized survey. 

The chapter begins with a discussion of key ethical and legal considerations for data acquisition:
...
The second section goes into detail on ensuring data quality if you are
collecting survey data.
It provides detailed guidance on the survey data generation workflow,
