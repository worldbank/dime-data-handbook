...
All mainstream data collection software automatically \index{encryption}\textbf{encrypt}\sidenote{
...
\subsection{Secure data storage -- during data collection}
...
encryption}\sidenote{\url{https://dimewiki.worldbank.org/wiki/Encryption\#Asymmetric\_Encryption}}
...
To proceed with data analysis, you typically need a to store the data somewhere else 
...
\url{https://dimewiki.worldbank.org/wiki/Encryption\#Symmetric\_Encryption}} where we 
create a secure encrypted folder, using for example VeraCrypt\sidenote{\url{https://www.veracrypt.fr/}}, 
...
be lost in case of hardware failure.\sidenote{\url{https://www.backblaze.com/blog/the-3-2-1-backup-strategy/}}
...
you must use a password manager\sidenote{\url{https://www.lastpass.com} or \url{https://bitwarden.com}}.
...
as well as assess the risk of statistical disclosure\index{statistical disclosure}.\sidenote{
Disclosure risk: the likelihood that a released data record can be associated with an 
individual or organization} There will almost always be a trade-off between accuracy and
privacy. For publicly disclosed data, you should favor privacy. There are a number of 
useful tools for de-identification: PII scanners for Stata\sidenote{\url{
https://github.com/J-PAL/stata_PII_scan}} or R\sidenote{\url{
https://github.com/J-PAL/PII-Scan}}, and tools for statistical disclosure control\sidenote{
\url{https://sdcpractice.readthedocs.io/en/latest/}}. In cases where PII data is required
