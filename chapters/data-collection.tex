...
or other public data addresses the inputs or outcomes of interest.
...
In the following chapter, we outline protocols for high-quality data acquisition,
to ensure that you clearly establish and document data access, 
and handle confidential data safely and securely.

This chapter covers the necessary components for secure data acquisition,
special considerations for acquiring high-quality survey data, 
and safe handling of all types of confidential data. 
...
The first step in data acquisition is to determine who owns the data, 
and establish and document the research teams rights to use the data. 
Except in the case of primary surveys funded by the research team, 
the data is typically owned by a third part. 
...
Particularly where confidential data is involved
...
you must be extremely clear up front about how the data will be used
...
This should be made explicit in the contract terms for the data collection. 
...
you must enter into a licensing or terms-of-use agreement to access it for research purposes.
...
of people who own the data and the people who are described in it;
...
Research teams that collect their own data must consider the terms
