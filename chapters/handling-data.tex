...
(We use ``reproducibility'' to refer to the code processes in a specific study.\sidenote{
...
If the research is well-structured, and the relevant documentation\sidenote{
  \url{https://dimewiki.worldbank.org/wiki/Data_Documentation}} is shared,
...
can help with this process where they are available.
  \index{pre-registration}\index{pre-analysis plans}\index{Registered Reports}
...
\textbf{GitHub}\sidenote{\url{https://github.com}} provides a transparent documentation system,\sidenote{
  \url{https://dimewiki.worldbank.org/wiki/Getting_started_with_GitHub}}
...
Raw data which contains PII \textit{must} be \textbf{encrypted}\sidenote{
...
First, all accounts need to be protected by strong, unique passwords.
...
Most modern data collection software has additional features that, if enabled, make secure transmission straightforward.\sidenote{\url{https://dimewiki.worldbank.org/wiki/SurveyCTO_Form_Settings}}
...
Secure storage and transfer are ultimately your personal responsibility.\sidenote{
...
Therefore, once data is securely collected and stored, the first thing you will generally do is \textbf{de-identify} it.\sidenote{
