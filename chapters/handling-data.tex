...
Their adoption is an objective measure to judge a research product's performance in both.
Without these transparent measures of credibility, reputation becomes the primary signal for the quality of evidence, and hence, two failures may occur:
...
Simple transparency standards mean that it is easier to judge research quality. Additionally, making high-quality research identifiable also increases its impact.
...
and therefore these principles are not by-products but core components of research output.
...
referring only to the code processes in a specific study;
in other contexts they may have more specific meanings.\sidenote{\url{http://datacolada.org/76}})
