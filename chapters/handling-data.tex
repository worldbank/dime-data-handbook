...
\begin{fullwidth}
  ...
  and always strive to to the best that you are capable of with current technology.
...
though there is much discussion about the use and definition of these concepts.\sidenote{
...
They also allow you to use issue trackers and abandoned work branches
...
in general, you are responsible for avoiding any action that
...
(b) never send confidential data over e-mail, WhatsApp, etc.
