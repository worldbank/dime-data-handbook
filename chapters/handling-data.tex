...
Finally, the corresponding data set should be openly accessible
...
that is, remove direct identifiers of the individuals in the data set.\sidenote{
...
to create a working de-identified data set that
...
before publicly releasing a data set.\sidenote{
