...
DIME is the Development Impact Evaluations department of the World Bank.\sidenote{
...
The DIME Analytics Resources Appendix provides an introduction to public materials.
...
In the past decade, this has started to change.\cite{swanson2020research}
There is new focus on reproducibility practices,
in part due to increasing requirements by publishers and funders to release code and data.
However, little practical guidance on effective and reproducible data workflows are available for practitioners,
with the exception of a recent handbook on reproducibility.\cite{christensen2019transparent}
...
is what we refer to as \textbf{process standardization}.\sidenote{
