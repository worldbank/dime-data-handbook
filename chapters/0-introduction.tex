...
Figure \ref{fig:intro} shows a summary of the hands-on data tasks 
comprising  research data work.
These are described in chapters 3 to 7.
Chapters 1 and 2, on the other hand,
will contextualize why these each of them are important,
...
\begin{fullwidth}
	\begin{figure}
		\centering
		\includegraphics[width=1.5\linewidth]{diagrams/Intro}
