...
Despite the growing importance, little practical guidance is available for practitioners
(with the notable exception of a recent handbook on reproducibility\cite{christensen2019transparent}).
...
research results become unreliable\cite{mccullough2008economics}
