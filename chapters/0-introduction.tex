...
follow coding style guides in their work.
Style guides harmonize code across teams 
making it easier to understand and reuse of code,
...
already have well-established and commonly used style guides,
 for example, the Tidyverse style guide for R
or PEP-8 for Python.\sidenote{See DIME Analytics Coding Standards:
	\url{https://github.com/worldbank/dime-standards}}. 
Stata has relatively few resources of this type available,
which is why we have created and shared one here that
