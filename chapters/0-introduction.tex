...
that already use the methods and tools outlined in it.
The book walks the reader through data work at each stage
...
We also introduce tools that are used to document
...
the \textbf{DIME Analytics Stata Style Guid}
