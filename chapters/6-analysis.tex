...
the pre-analysis plan should serve as your guide at this stage.\index{Pre-analysis plan}
...
to the unit of \textit{analysis}.\sidenote{\url{
...
Construction follows data cleaning for two reasons.
