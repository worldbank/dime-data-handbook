...
and add checks to your code to verify that they match what you expect.
...
Integrating datasets with different units of observation often involve changing the structure of the data,
such as transforming the unit of observation through aggregation or reshapes.
