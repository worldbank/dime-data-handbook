...
This section discussed the steps needed to take original data
and create analysis datasets and outputs from it.
This process created new derived information
from measurements taken in the field or collected by partners,
and combined these measures with the research design
described in the data map and the analysis plan.
...
Creating organized and well-documented code
for both the creation of new information
and the creation of research outputs describing
patterns you identified in the data --
and used to answer your research questions --
provides this knowledge to both future users of the original data
as well as readers interested in completely understanding
the results you obtained.
The final chapter of this book will provide a guide
to pulling these raw findings together into publishable work,
