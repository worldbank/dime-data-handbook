...
These will be \textbf{exported}\sidenote{
  \textbf{Export:} The creation of publication-ready representations of results.}\index{exporting results} 
...
\textbf{Dynamic documents}\sidenote{
  \textbf{Dynamic documents:} File types that encode direct references
