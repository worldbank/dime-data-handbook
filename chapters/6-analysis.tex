...
one or multiple well-documented tidy\cite{hadley2017R}\sidenote{
	\url{Available at
...
It's possible data the acquired data is ready for analysis,
...
you may need to construct many purpose-built analysis datasets.
...
from different data sources.\sidenote{
	\url{https://dimewiki.worldbank.org/wiki/Data_Integration}}
...
How to treat outliers is a research question.\sidenote{
	\url{https://dimewiki.worldbank.org/wiki/Variable_Construction\#Dealing_with_outliers}}
...
it is wise to start writing a variable dictionary as soon as you begin making changes to the data.\sidenote{
	For an example of what a published data dictionary looks like, see Appendix A in \cite{jones2019factor}}
...
First of all, we maintain two repositories containing
data and code to create graphs: 
the \textbf{Stata Visual Library}\sidenote{
	\url{https://worldbank.github.io/Stata-IE-Visual-Library}} 
and the \textbf{R Econ Visual Library}.\sidenote{
	\url{https://worldbank.github.io/https://worldbank.github.io/r-econ-visual-library/}}
Both these resources are inspired in the \textit{The R Graph Gallery},\sidenote{
	\url{https://www.r-graph-gallery.com}}
but the first focuses on Stata,
and the second includes material on common visualizations used in
development economics.
They are organized in such a way that
you can get a good sense of what your data should look like
before you start writing code to create a visualization.
