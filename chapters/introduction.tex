...
primary data \marginnote{\textbf{Primary data:} data collected from first-hand sources.}
...
\marginnote{\textbf{Field experiment:} experimental intervention in the real world, rather than in a laboratory.}
...
\marginnote{The \textbf{DIME Wiki} is one of our flagship resources for project teams,
as a free online collection of our resources and best practices.
\newline \noindent \url{http://dimewiki.worldbank.org/}}You will be working with people
...
\marginnote{You can download or contribute to this book at: \url{http://worldbank.github.com/d4di}}
As we have worked with more and more DIME recruits
\marginnote{We will use broad terminology throughout this book
...
handling technical capacity and analytical tasks.}we have realized that we barely have the time to give everyone the attention they deserve.
...
with a guided tour of the major tasks that make up primary data collection.\marginnote{Like this:}\sidenote{\url{https://dimewiki.worldbank.org/wiki/Primary_Data_Collection}}
...
\marginnote{We always tell people to ``code as if a stranger would read it''.
The reason? Tomorrow, that stranger will be you.}The \textbf{structure} is the environment your code lives in:
...
\begin{minipage}{1.5\textwidth}
	...
	label=code.do, %name of code section
	...
	]{./code/code.do} %Write the relative file path and the name of the file to be included
	\vspace{.3cm}
\end{minipage}
...
\marginnote{We will not explain Stata commands unless the behavior we are exploiting
...
whenever you do not understand the functionality that is being used.}We hope
