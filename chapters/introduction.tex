...
The book covers each stage of an empirical research project, from design to publication.
...
Stata is the notable exception here due to its current popularity in development economics.\sidenote{
