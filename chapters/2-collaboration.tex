...
When using file system encryption, you create encrypted folders 
...
and when you share data over insecure channels like DropBox and email.\index{data transfer}
