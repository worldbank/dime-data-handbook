...
and it is the responsibility of the research team to satisfy these expectations.\sidenote{
	\url{https://dimewiki.worldbank.org/Research_Ethics}}\index{research ethics}
...
Note that it is in practice impossible to \textbf{anonymize} data.\index{data anonymization}
