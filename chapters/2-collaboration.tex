...
% ----------------------------------------------------------------------------------------------
\subsection{Establishing effective documentation practices}
...
% ----------------------------------------------------------------------------------------------
\subsection{Setting up your code environment}
...
\subsection{Establishing common file formats}
...
\subsection{Setting up version control}
...
% ----------------------------------------------------------------------------------------------
\subsection{Writing code that others can read}
...
\subsection{Writing code that others can run}
...
\section{Preparing to handle confidential data ethically}
...
\subsection{Seeking ethical approval}
...
\subsection{Obtaining informed consent}
...
\subsection{Ensuring research subject privacy}
...
Third, all confidential data must be encrypted at all times.\sidenote{
	\textbf{Encryption:} Methods which ensure that files are unreadable 
