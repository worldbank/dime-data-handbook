...
and add to them whenever new subfolders are created in the \texttt{DataWork} folder.\index{\texttt{iefolder}}
...
disclose their identify, even though those variables would not be considered PII in general.
  \index{personally-identifying information (PII)}
...
you will have a firm idea about how we are going to
handle the data and code that
you create and receive throughout the research process.
...
you are also ready to handle materials ethically and securely.
You should also have secured the approvals needed for any planned work.
You are now ready to start creating the data materials needed
to answer your research questions.
In the next chapter,
we will do this through an essential type of research planning:
mapping data to both the research design
and to its planned creation and use across the project timeline.
