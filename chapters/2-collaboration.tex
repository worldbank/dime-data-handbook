...
The only way to make that practically feasible is to use a password manager.\sidenote{
	See DIME's guide to password managers -
	\url{https://github.com/worldbank/dime-standards/blob/master/dime-research-standards/pillar-4-data-security/data-security-resources/password-manager-guidelines.md}}
...
our protocols are available on in the DIME Research Standards.\sidenote{\url{
		https://github.com/worldbank/dime-standards/blob/master/dime-research-standards/pillar-4-data-security/data-security-resources/veracrypt-guidelines.md}}
