...
some kind of \textbf{file sharing} software.\sidenote{
  More details on file sharing software and
  other collaboration tools mentioned in this section
  can be found on the DIME Wiki:
...
to support version and settings stability in Stata.\sidenote{
  ...
  harmonize settings across users as much as possible in Stata,
...
as a part of our \texttt{ietoolkit} package.\sidenote{
  Read more about how to install and use this command,
...
before publicly releasing a dataset.\sidenote{
  More details and best practices related to de-idnetification
