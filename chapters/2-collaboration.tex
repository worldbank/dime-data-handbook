...
You might also consider using an external editor for your R or Stata code.\sidenote{\url{https://dimewiki.worldbank.org/Stata_Coding_Practices}}
...
or firms (or other units) in your data.
...
but it may only be supported in enterprise versions of operative systems,
...
to \textbf{anonymize} data.\index{de-identification}\index{anonymized data}
