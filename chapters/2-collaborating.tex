...
This means knowing which datasets and outputs you need at the end of the process,
...
into a new code environment while it is still ongoing.
...
As often as not, you come up with the wrong folder structure,
...
Setting up the \texttt{DataWork} folder in a version-controlled directory
...
It is common for teams to maintain one analysis file or folder with draft code or ``exploratory analysis'',
