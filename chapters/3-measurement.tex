...
Randomization makes it possible to obtain an unbiased estimate of 
the effects that can be attributed to a specific program or intervention.\sidenote{\citet{duflo2007using}, {JPAL\_RCT}}
...
that is, the correlation goes to zero as the sample size goes to inifinity.
