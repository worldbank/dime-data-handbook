...
Most projects require data source to answer all their research questions.
However your study is structured, you need to know how to link data from all sources
and analyze the relationship between their units
to manage its data successfully.
...
The only way to make sure that the whole team shares the same understanding
...
list all observations at your project ever encountered
...
or in any other way linking different data tables.
...
cannot be unambiguously linked to the project ID, 
...
and therefore all such variables should be present,
unlike \textbf{measurement variables}\sidenote{
	...
	These variables are not controlled by the research team
...
and information on your outcome or interest (measurement variable),
you should first identify research variables, 
