...
tools for assessing the statistical validity of the design.
...
as either \textbf{research design variables}\index{research design variables} 
or \textbf{measurement variables}\index{measurement variables}
