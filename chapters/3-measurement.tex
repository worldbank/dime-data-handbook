...
data acquired from different partners (such as administrative data,
web scraping, implementation monitoring, and so on)
...
such as ID values, sampling and treatment statuses, and so on.
...
or in any other way linking different datasets.
...
it should be a piece of documentation that is 
...
all the datasets you know you will use in a spreadsheet.
...
The data linkage table is also a great place to list other types of metadata,
such as the source of your data, its backup locations, and so on.
...
The operations used to combine the data could, for example, be
...
and if the operation creates a new variable or combination of variables
that identifies the newly linked data.
...
or simply by drawing on a piece of paper and taking a photo.
