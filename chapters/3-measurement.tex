...
Planning data requirements should be more than
just a listing of the key outcome variables. 
...
determine the data needs of the project, 
...
These three tools should be the way data requirements are communicated
...
Those two research activities are random sampling and random assignment.
...
but not include any \textbf{measurement variables}\sidenote{
	...
	or any other aspect we are trying to measure. 
	Research variables are not controlled by the research team and often vary over time.
