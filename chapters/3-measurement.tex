...
\section{Documenting data needs}
...
\subsection{Developing a data linkage table}
...
and the name of the \textbf{project ID}\sidenote{
	...
	See \url{https://dimewiki.worldbank.org/ID\_Variable\_Properties\#Project_ID} for more details.}
...
\subsection{Constructing master datasets}
...
\subsection{Creating data flowcharts}
...
\section{Translating research design to data needs}
...
\subsection{Applying common research designs to data}
...
%-----------------------------------------------------------------------------------------------
\subsection{Including multiple time periods}
...
%-----------------------------------------------------------------------------------------------
\subsection{Incorporating monitoring data}
...
\subsection{Implementing clustered or stratified designs}
...
\subsection{Performing power calculations}
