...
which we call \textit{research variables};
...
We will briefly cover the most commonly used 
...
Instead, we will give examples on the specific data needs they have, 
and how to document those in our data map template.

The third section of the chapter covers how to reproducibly generate research variables,
...
to communicate this information across a team is to use a diagram.
...
and decide which research variables you will need in the data analysis
to infer the relation between differences in measurement variables
and your research design.
It is very likely that you will have to make several modifications
...
so you can best plan your data acquisition according to your research needs.
...
Monitoring data can be collected by sending someone to the field to record observations, 
but it is more and more common that you can collect monitor data remotely. 
For example by scraping social media platforms
or by applying image recognition to satellite images.
Development practitioners are still in an early stage 
of exploring how to use new types of data to 
monitor the implementation of our research 
