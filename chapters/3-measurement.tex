...
is to create a \textbf{data map}\index{data map}.\sidenote{
  More details and links to related topics with examples
...
\texttt{iebaltab}.\sidenote{
  Read more about how \texttt{iebaltab}
  simplifies balance tables in Stata,
  and how to install this command on the DIME Wiki:
...
to be included in data collection when the cost of collecting data on everyone is prohibitive.\sidenote{
  More details on this and links to even more extensive resources
  can be found on the DIME Wiki:
...
The \texttt{ieboilstart} command in \texttt{ietoolkit} provides functionality to support this requirement.\sidenote{
  Read more about how \texttt{ieboilstart} can help you
  harmonize settings such as version across users,
