...
are essential data components for completing CONSORT\marginnote{\textbf{CONSORT:} Add definition.} records.\cite{begg1996improving}
...
allows you to store passwords as well as small keyfiles like this.} Make sure you store keyfile with descriptive names to match the survey to which it corresponds.
