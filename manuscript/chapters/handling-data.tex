...
The textbf{Open Science Framework}\sidenote{\url{https://osf.io/}} provides one such solution,
...
means that the actual analytical processes you usedare executable by others.
