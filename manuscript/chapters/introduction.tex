...
\marginnote{You can download or contribute to this book at: \url{http://worldbank.github.com/d4di}}As
we have worked with more and more DIME recruits
\sidenote{We will use broad terminology throughout this book
to refer to different team members:
principal investigators (PIs) who are responsible for
the overall success of the project;
field coordinators (FCs) who are responsible for
the operation of the project on the ground;
and research assistants (RAs) who are responsible for
handling technical capacity and analytical tasks.}
-- principal investigators, field coordinators, and research assistants --
