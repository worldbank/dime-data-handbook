...
code and process reusability,\sidenote{
...
For Stata, we recommend the text and code editor Atom,\sidenote{\url{https://atom.io}}
...
\index{ietoolkit}\index{iefieldkit}
...
This book and the DIME Wiki\sidenote{url{https://dimewiki.worldbank.org}}
