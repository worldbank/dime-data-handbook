...
\textbf{Stata Visual Library.\sidenote{
...
\textbf{R Econ Visual Library.\sidenote{
...
\textbf{DIME Analytics Research Standards.\sidenote{
...
\textbf{Manage Successful Impact Evaluation Surveys (MSIES).\sidenote{
...
\textbf{Research Assistant Onboarding Course.\sidenote{
...
\textbf{Introduction to R for advanced Stata users\sidenote{
...
\textbf{DIME Analytics Trainings.\sidenote{
		\url{https://osf.io/wzjtk}}}
...
\textbf{DIME Analytics GitHub Trainings and Resources.\sidenote{
...
\textbf{DIME Analytics \LaTeX-training.\sidenote{
