...
We only use Stata's built-in data sets in our code examples,
...
if the data set is changed or even simply reordered.
...
The command \texttt{compress} makes the data setsmaller in terms of memory usage
