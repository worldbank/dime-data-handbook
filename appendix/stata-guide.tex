...
All file paths should be absolute and dynamic and should always be enclosed in double quotes. Absolute
file paths means that the file paths starts at the very root folder of the computer. This makes sure that
...
Dynamic file paths use globals that are set in a central master do-file to dynamically build your file
