...
as well as placebo testing for non-realized locations of the cutoff.\cite{cattaneo2019}

In the analytical stage, regression discontinuity designs
often include a large component of visual evidence presentation.\cite{baumer}
...
and implementations of the design it can be complex to operate.\cite{hainmueller}
