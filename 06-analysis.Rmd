# Constructing and analyzing research data
...
*R for Data Science*;^[@hadley2017R]
*A Practical Introduction to Stata*;^[@RePEc:gdm:wpaper:9412]
*Mostly Harmless Econometrics*;^[@angrist2008mostly]
and *Causal Inference: The Mixtape*.^[@cunningham2018causal]
...
![Data analysis tasks and outputs](diagrams/Analysis.png)
