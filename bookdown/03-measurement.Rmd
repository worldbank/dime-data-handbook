...
8.	The research design variables, which translate the research design into data. These can include:
...
•	Monitoring indicators, which characterize the implementation of activities under study or data collection
9.	Outputs of random processes. Random processes, implemented through statistical software, are often needed to translate research designs into data work. These random processes share common characteristics and can include:
...
o	https://dimewiki.worldbank.org/Data_Linkage_Table
o	https://dimewiki.worldbank.org/Data_Flow_Chart
o	https://dimewiki.worldbank.org/Master_Data_Set
•	See the “Research design for impact evaluation” Appendix of this book, which includes intuitive descriptions of common impact evaluation research designs, targeted to research staff without PhD training such as research assistants and field coordinators
...
| Data source	| Raw dataset name | Unit of observation \n (ID var) |	Parent unit \n (ID var) |
|-------------|------------------|---------------------------------|--------------------------|
| Platform survey	| platform_survey_raw_deidentified.dta	| respondent (id)	 | |
| Gender-career \n implicit association test	| career_stimuli.dta	| stimulus	| respondent (id) \n question block (block) |
| Car choice-safety concerns \n implicit association test	| security_stimuli.dta	| stimulus	| respondent (id) \n question block (block)| 
| Car choice-openness to advances \n implicit association test	| reputation_stimuli.dta |	stimulus	| respondent (id) \n question block (block) |
| Gender-career \n implicit association test |	career_score.dta |	respondent (id)	 ||
| Car choice-safety \n concerns implicit association test |	security_score.dta	| respondent (id)	 ||
| Car choice-openness to advances \n implicit association test |	reputation_score.dta	| respondent (id)	 ||

> The full data map for the project is available at https://git.io/Jtg3J 
...
You should reference our **Research Design Appendix**,
