...
4.	**The technical collaboration environment.** No matter the hardware and software your team plans to use, you should ensure now that it is standardized or interoperable across the team. This includes:
...
5.	The **organization of code and data**. The team should agree on where and how code files and databases will be stored, down to the level of the folder structure. This involves setting up:
...
6.	**Information security measures and ethical frameworks**. These include:
...
```{stata, eval = F, attr.source='.numberLines'}
/*******************************************************************************
